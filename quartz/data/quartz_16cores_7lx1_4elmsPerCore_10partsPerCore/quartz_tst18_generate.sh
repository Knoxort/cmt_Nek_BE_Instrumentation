...
#/g/g19/trokon/workspace/tst_2018_nek5000_lpm_benchmarking_repo/quartz/bin/makenek clean
/g/g19/trokon/workspace/tst_2018_nek5000_lpm_benchmarking_repo/quartz/bin/makenek uniform
...
then
	...
	echo "#MSUB -l walltime=06:00:00" >> run.sh		#Eventually 12hrs when all working
