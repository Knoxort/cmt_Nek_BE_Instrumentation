c-----------------------------------------------------------------------
      ...
      ! coupled stokes drag (we could have set forceqs = 1 in .par
      ! instead, but this is for demonstration)
      rdum = lpmvol_p*lpmdens_p/lpmtau_p
      lpmforcec(1) = rdum*(lpmv_f(1) - lpmv_p(1))
      lpmforcec(2) = rdum*(lpmv_f(2) - lpmv_p(2))
      lpmforcec(3) = rdum*(lpmv_f(3) - lpmv_p(3))
