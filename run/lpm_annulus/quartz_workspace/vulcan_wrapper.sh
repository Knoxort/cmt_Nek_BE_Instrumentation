...
do
  ...
  do
    ...
    do
      ...
      do
                        cd $root
			mkdir 'vulcan_core_'$core'lx1_'$lx1'lelt_'$elpercore'alpha_'$alpha
			cp SIZE './vulcan_core_'$core'lx1_'$lx1'lelt_'$elpercore'alpha_'$alpha
                        cp README './vulcan_core_'$core'lx1_'$lx1'lelt_'$elpercore'alpha_'$alpha
		       
                        cp uniform.* './vulcan_core_'$core'lx1_'$lx1'lelt_'$elpercore'alpha_'$alpha
                        #cp cmtparticles.usrp './core_'$core'lx1_'$lx1'lelt_'$elpercore'alpha_'$alpha
                        cp vulcan_generate.sh './vulcan_core_'$core'lx1_'$lx1'lelt_'$elpercore'alpha_'$alpha
                        #cp clean.sh './core_'$core'lx1_'$lx1'lelt_'$elpercore'alpha_'$alpha
                        #cp makenek './core_'$core'lx1_'$lx1'lelt_'$elpercore'alpha_'$alpha
		        cd './vulcan_core_'$core'lx1_'$lx1'lelt_'$elpercore'alpha_'$alpha
