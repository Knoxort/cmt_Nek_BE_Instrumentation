...
do
  ...
  do
	...
	cd $root
	mkdir 'quartz_'$numCore'core_'$lx1'lx1'$elpercore'elmsPerCore'
	cp input_SIZE uniform.* README tst18_quartz_generate.sh clean.sh makenek 'quartz_'$numCore'core_'$lx1'lx1'$elpercore'elmsPerCore'
	cd 'quartz_'$numCore'core_'$lx1'lx1'$elpercore'elmsPerCore'
	cp input_SIZE SIZE
