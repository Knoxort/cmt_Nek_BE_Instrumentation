...
do
  ...
  do
	...
	/g/g19/trokon/workspace/tst_2018_nek5000_lpm_benchmarking_repo/vulcan_benchmarking/bin/genbox < gbox.in
	mv box.re2 uniform.re2
	echo "uniform" > gmap.in
	echo "0.2" >> gmap.in
	/g/g19/trokon/workspace/tst_2018_nek5000_lpm_benchmarking_repo/vulcan_benchmarking/bin/genmap < gmap.in
